    ...
    return (
        <Link href={`/articles/${article.documentId}`} passHref>
            <div
                ...
                <div className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 h-15 overflow-hidden text-ellipsis">
                        {article.title}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 h-15 overflow-hidden text-ellipsis">
                        {article.description}
                    </p>
                    <div className="flex items-center justify-between">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-sm">{formatDate(article.publishedAt)}</p>
                    </div>
                </div>
            </div>
        </Link>
